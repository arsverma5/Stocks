...
import oldstocksimulator.oldcontroller.StockController;

import static org.junit.Assert.assertEquals;

/**
 * This test class will test the controller as well as the view
...
public class ControllerTest {
  ...
  public void setUpExpected() {
    expected.append("Menu: " + System.lineSeparator() +
            ...
            "5. portfolio-menu <portfolioName> <ownerName> " +
            "(access portfolio options)" + System.lineSeparator() +
  ...
  public void setUpCreatePortfolio() throws IOException, ParseException {
    setUp();
    sb.append("create-portfolio MyPortfolio John")
    ...
    IController controller = new StockController(model, input, view);
  ...
  public void setUpRemovePortfolio() throws IOException, ParseException {
    ...
    expected.append("Creating portfolio MyPortfolio owned by John")
            .append(System.lineSeparator());
    setUpExpected();
    sb.append("remove-portfolio MyPortfolio John")
            .append(System.lineSeparator());
    expected.append("Deleting portfolio MyPortfolio for John\n");
    setUpExpected();
  ...
  public void setUpStockMenu() throws IOException, ParseException {
    setUp();
    sb.append("stock-menu GOOG")
            .append(System.lineSeparator());
    expected.append("Stock Menu: GOOG\n")
            .append("Enter a number for a command, after which you will be asked " +
  ...
  public void setUpPortfolioMenu() throws IOException, ParseException {
    ...
    sb.append("portfolio-menu MyPortfolio")
            .append(System.lineSeparator());
    expected.append("Portfolio Menu: MyPortfolio\n")
            .append("Enter a number of a command, after which you will be asked " +
                    "for specific parameters: \n")
  ...
  public void setUpMainMenu() throws IOException, ParseException {
    ...
    sb.append("main-menu")
            .append(System.lineSeparator());
    expected.append("Welcome to the stock program!\n")
            .append("Menu: \n")
            .append("Enter a number for a command, after which you will be asked " +
                    "for specific parameters: \n")
            .append("1. create-portfolio <portfolioName> <ownerName> " +
                    "(create a new portfolio)\n")
            .append("2. remove-portfolio <portfolioName> " +
                    "<ownerName> (remove an existing portfolio)\n")
            .append("3. view-portfolios (view existing " +
                    "portfolios)\n")
            .append("4. stock-menu <tickerSymbol> " +
                    "(access stock options)\n")
            .append("5. portfolio-menu <portfolioName> " +
                    "<ownerName> (access portfolio options)\n")
            .append("6. main-menu (print this menu again)\n")
            .append("7. quit (quit the program)\n")
            .append("Enter your choice: \n");
  ...
  public void setUpQuit() throws IOException, ParseException {
    setUp();
    sb.append("quit").append(System.lineSeparator());
